...
HOME_PAGE = webbrowser_home_page
NEW_PAGE = "about:blank"
CREATE_BROWER = True

print("当前设置主页为: \n",webbrowser_home_page)
...
class TabBarDe(QTabBar):
    ...
    def rightMenuShow(self):
        try:
            ...
            index_button = QPushButton(chr(0xf015),
...
class Browser(QMainWindow):
    ...
    def moreMenuShow(self):
        try:
            ...
            self.contextMenu.addMenu("打印当前页面   Print")
    ...
    def initToolbar(self, webview):
        ...
        # 添加前进、后退、停止加载和刷新的按钮
        self.reload_icon = chr(0xf2f9)
        self.stop_icon = chr(0xf00d)

        # 后退按钮
        self.back_action = QWidgetAction(self)
        self.back_button = QPushButton(chr(0xf060), self,
        ...
        self.next_button = QPushButton(chr(0xf061), self,
        ...
        # 放大按钮
        self.zoom_in_button = QPushButton(chr(0xf067), self,
        ...
        # 缩小按钮
        self.zoom_out_button = QPushButton(chr(0xf068), self,
                                           clicked=self.zoom_out_func,
                                           font=fontawesome("far"),
        ...
        # 全屏按钮
        self.full_screen_button = QPushButton(chr(0xe140), self,
        ...
        self.more_button = QPushButton(chr(0xe235), self,
        ...
        self.index_button = QPushButton(chr(0xf015), self,
                                        # clicked=self.zoom_out_func,
                                        font=fontawesome("far"),
        ...
        self.urlbar.setFont(QFont('Microsoft YaHei', 13))
...
class TitleBar(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.titleLabel.setText("MXD-BrowserV1.0")
    ...
    def loadFnBtn(self):
        ...
        # 添加新的标签页
        self.buttonAddPage = QPushButton(chr(0xf067), self, clicked=self.addPaged.emit, font=fontawesome("far"),
...
class FramelessWindow(QWidget):
    ...
    def initTab(self):
        ...
        self.setMinimumSize(QSize(height * 1, width * 1))
        # self.center()
        # self.show()
